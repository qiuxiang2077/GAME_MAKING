...
> **对应设计文档**: `dev/docs/设定.md`（玩法机制-解谜系统）  
> **文档类型**: 技术实现设计  
> **创建日期**: 2026-04-20
...
| 文件路径 | 说明 | 依赖 |
|---------|------|------|
| `game/scripts/puzzles/puzzle_base.gd` | 谜题基类 | 无 |
| `game/scripts/puzzles/pressure_plate.gd` | 压力踏板 | puzzle_base |
| `game/scripts/puzzles/switch_door.gd` | 开关门 | puzzle_base |
| `game/scripts/puzzles/pushable_box.gd` | 推拉箱子 | 无 |
| `game/scripts/puzzles/toggle_switch.gd` | 拨动开关 | puzzle_base |
